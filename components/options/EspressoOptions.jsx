...
export default function EspressoOptions({ typeOfDrink }) {
    ...
    return (
        ...
        <div className="lg:w-2/3 lg:mx-auto flex gap-6 lg:flex-row flex-col justify-between py-4">
            <div className=''>
                <h1 className='text-2xl font-bold border-b-4'>
                    Size Options
                </h1>
                <select name="size" onChange={handleChange} className="select select-ghost w-full lg:max-w-xs">
            ...
            <div className="lg:w-2/3">
                ...
                <div className="lg:w-1/2">
                    ...
                    <h1>Milk Type</h1>
                    <select name="milk" onChange={handleChange} className="select select-ghost w-full lg:max-w-xs">
                    ...
                    <select name="roast" onChange={handleChange} className="select select-ghost w-full lg:max-w-xs">
